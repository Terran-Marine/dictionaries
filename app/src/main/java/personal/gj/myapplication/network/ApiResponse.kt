...
sealed class ApiResponse<T> {
    companion object {
        ...
        fun <T> create(response: Response<HttpResponse<T>>): ApiResponse<T> {
            ...
            return if (response.isSuccessful) {
                ...
                when {
                    ...
                    else -> apiErrorResponse(ServiceException(404, "暂时假的")) //服务器异常
                }
            } else {
        ...
        private fun <T> apiErrorResponse(e: Throwable): ApiErrorResponse<T> = ApiErrorResponse(
            HandleException.handle(e).message
                ?: "Unknown Error"
        )
    }
}
        ...
        links[NEXT_LINK]?.let { next ->
            ...
            if (!matcher.find() || matcher.groupCount() != 1) {
                ...
                try {
                    ...
                    Logger.w("ApiSuccessResponse", "cannot parse next page from $next")
                    null
                }
            }
        }
